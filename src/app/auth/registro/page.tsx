    ...
    try {
      ...
      const { error } = await supabase.auth.signUp({
        ...
        options: {
          ...
          emailRedirectTo: `${storeConfig.url}/auth/callback?redirect=${redirectTo}`,
        },
      });
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      const { error } = await supabase.auth.signInWithOAuth({
        provider: "google",
        options: {
          redirectTo: `${storeConfig.url}/auth/callback?redirect=${redirectTo}`,
        },
      });
  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader className="text-center">
        ...
        <CardDescription>
          Registrate en {storeConfig.name} y empezá a comprar
        </CardDescription>
      </CardHeader>
